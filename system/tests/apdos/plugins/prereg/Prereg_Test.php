...
use tests\apdos\plugins\prereg\mock_prereg_storage;
use tests\apdos\plugins\prereg\afreeca_prereg_user_dto;
...
class Prereg_Test extends Test_Case {
  ...
  public function test_register_with_values() {
    $this->prereg->start($this->storage, 'tests\apdos\plugins\prereg\Afreeca_Prereg_User_DTO');
  ...
  public function set_up() {
    ...
    $this->storage = $actor->add_component('tests\apdos\plugins\prereg\Mock_Prereg_Storage');
  }
