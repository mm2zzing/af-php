<?php
namespace af\tests\kernel\actor\property;
...
class Property_Test extends Test_Case {
  ...
  public function test_get() {
    $actor1 = Kernel::get_instance()->new_object('af\kernel\actor\Actor', '/test1');
    $component1 = $actor1->add_component(Test_Component::get_class_name());

    $actor2 = Kernel::get_instance()->new_object('af\kernel\actor\Actor', '/test2');
