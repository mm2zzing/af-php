...
class MySQL_Schema_Test extends Test_Case {
  ...
  public function set_up() {
    $actor = Kernel::get_instance()->new_object('af\kernel\actor\Actor', '/sys/db/mysql');
    $this->connecter = $actor->add_component('af\plugins\database\connecters\mysql\MySQL_Connecter'); 
    ...
    $this->schema = $actor->add_component('af\plugins\database\connecters\mysql\MySQL_Schema');
  }
