...
use af\kernel\log\handlers\Logd_Handler;
...
class Logger extends Component { 
  ...
  public static function get_instance() {
    ...
    if (null == $instance) {
      $actor = Kernel::get_instance()->new_object('af\kernel\actor\Actor', '/sys/logger');
      $instance = $actor->add_component('af\kernel\log\Logger');
