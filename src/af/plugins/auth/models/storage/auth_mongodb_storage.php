...
Loader::get_instance()->include_module('af/plugins/auth/models/storage/auth_storage');
Loader::get_instance()->include_module('af/plugins/auth/dto/user_dto');
Loader::get_instance()->include_module('af/plugins/db_connecters/mongodb/mongodb_connecter');
Loader::get_instance()->include_module('af/plugins/db_connecters/mongodb/write_concern');
Loader::get_instance()->include_module('af/kernel/core/object_converter');
