...
class Tool_Config extends Component {
  public function select_tool($tool_actor, $tool_path) {
    ...
    $this->config = $tool_actor->add_component('af\plugins\config\Config');
  ...
  public static function get_instance() {
    ...
    if (null == $instance) {
      $actor = Kernel::get_instance()->new_object('af\kernel\actor\Actor', '/sys/tool_config');
      $instance = $actor->add_component('af\tools\ash\Tool_Config');
    }
    return $instance;
  }
