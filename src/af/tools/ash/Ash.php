...
use af\tools\ashconsole\Command_Line;
use af\tools\ash\console\error\Command_Line_Error;
use af\tools\ash\error\Ash_Error;
use af\kernel\log\Logger;
use af\kernel\actor\Component; use af\kernel\actor\net\Actor_Connecter;
use af\tools\ash\events\Shell_Command;
use af\tools\ash\dto\Argument_DTO;
...
class Ash extends Tool {
  ...
  public function __construct() {
    $this->actor_connecter = Component::create('af\kernel\actor\net\Actor_Connecter', '/bin/actor_connecter');
  } 
  ...
  private function create_line_input() {
    $result = Component::create('af\tools\ash\console\Command_Line', '/bin/cmd_line');
